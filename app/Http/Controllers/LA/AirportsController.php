...
class AirportsController extends Controller
{
	...
	public $listing_cols = ['id', 'IATAcode', 'ICAOcode', 'Name', 'Area', 'IsActive'];
	...
	public function dtajax()
	{
		...
		for($i=0; $i < count($data->data); $i++) {
			...
			if($this->show_action) {
				if(Module::hasAccess("Airports", "edit") || Module::hasAccess("Airports", "delete")) {
