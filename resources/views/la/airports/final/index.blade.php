	...
	<div class="box-header with-border">
		<div class="content-header">
			...
			@la_access("Airports", "create")
				<button class="btn btn-flat btn-primary pull-right" id="AddBtn"><i class="fa fa-plus-square"></i>&nbsp;&nbsp;Thêm sân bay mới</button>
			@endla_access
			</span>
		</div>
	</div>
...
$("#AddBtn").click(function() {
	...
	$('#AddModalContent').html($('#AddModalContent').html());
	loadUI();
	$('#AddModal').modal('show');
