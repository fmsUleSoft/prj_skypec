...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $temporaryprice->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("TemporaryPrices", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/temporaryprices/'.$temporaryprice->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("TemporaryPrices", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.temporaryprices.destroy', $temporaryprice->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/temporaryprices') }}" data-toggle="tooltip" data-placement="right" title="Back to TemporaryPrices"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'contract')
						@la_display($module, 'routetype')
						@la_display($module, 'unit')
						@la_display($module, 'currency')
						@la_display($module, 'unitprice')
					</div>
				</div>
			</div>
		</div>
