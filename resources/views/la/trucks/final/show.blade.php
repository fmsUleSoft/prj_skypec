			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'Mark')
						@la_display($module, 'Tablet')
						@la_display($module, 'LCR')
						@la_display($module, 'ChassisNumber')
						@la_display($module, 'EngineNumber')
						@la_display($module, 'UsedYear')
						@la_display($module, 'Capacity')
