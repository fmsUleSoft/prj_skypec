...
<div class="box box-widget">
	<div class="box-header with-border">
		<div class="content-header">
			<h1><i class="fa fa-cube"></i> MODULES<small>| Danh sách module</small></h1>
			<span class="headerElems">
				<button class="btn btn-success btn-sm pull-right" data-toggle="modal" data-target="#AddModal"><i class="fa fa-plus-square"></i>&nbsp;&nbsp;Thêm module mới</button>
			</span>
		</div>
	</div>
	<div class="box-body">
		<table id="dt_modules" class="uk-table uk-table-hover uk-table-striped" style="width:100%">
		<thead>
		<tr class="success">
			<th>ID</th>
			<th>Name</th>
